    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            textColor: "#f6f9fc"
            selectedTextColor: "#f6f9fc"        // The highlighted text color
            selectionColor: "#003c96"           // The text highlight color
            placeholderTextColor:"#f6f9fc"      // When the text field is empty
            background: Rectangle {
                color: "#003c96"
                radius: 2
                                                    //focus   //normal
                border.color: control.activeFocus ? "#003c96" : "#003c96"
                border.width: 1
                implicitWidth: 100
                implicitHeight: 30
            }
    ...
    PlasmaComponents.Button {
        ...
        style: ButtonStyle {
            background: Rectangle {
                border.width: 1
                                                    //focus   //normal
                border.color: control.activeFocus ? "#003c96" : "#483d8b"
                radius: 2
                gradient: Gradient {                                      //pressed   //normal
                    GradientStop { position: 0 ; color: control.pressed ? "#003c96" : "#483d8b" }
                    GradientStop { position: 1 ; color: control.pressed ? "#483d8b" : "#483d8b" }
                }
                //implicitWidth: 100
                implicitHeight: 30
            }
